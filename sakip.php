	...
	<div class="container">					
		<div class="row">
			<div class="col-lg-8">
				...
				<div class="row">
					<?php
						$sql = mysqli_query($con,"SELECT * FROM tb_dokumen WHERE KATEGORI = 'sakip' ");
				...
				<div class="single-widget recent-posts-widget">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-10">
							...
							<div style="text-align: center;">
								<a href="?page=renja">
									<h4 style="font-size: 16px; font-weight: 500; margin-top: 10px;">RENJA</h4>
								</a>
							</div>
						</div>
					</div>
